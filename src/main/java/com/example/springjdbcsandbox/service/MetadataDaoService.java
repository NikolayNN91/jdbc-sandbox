...
public class MetadataDaoService {
    ...
    public MetadataDaoService(FileMetadataDao fileMetadataDao) {
    ...
    public int[] batchCreateMetadata(List<FileMetadataDto> metadataList) {
        List<FileMetadata> entities = convertToEntity(metadataList);
    ...
    private List<FileMetadata> convertToEntity(List<FileMetadataDto> metadataList) {
